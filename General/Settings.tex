...
\newcommand\reporttitle{Los Desfibriladores y su Fundamento en la Física: Una Mirada a Física II}

% Insert course code, name, quartile number and year (or any other subtitle)
\newcommand\reportsubtitle{
Física II, name - Qx (202x)
}
...
Juan Manuel Young Hoyos & Student number \\
Juan Fernando & Student number \\
Juan José & Student number \\
Copy me & Copy me \\
}
